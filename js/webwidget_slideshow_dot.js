    ...
    a.fn.webwidget_slideshow_dot=function(p){
        ...
        function init(){
           ...
           // x.find(".thumb_box").append('<span><img src="'+d+'carousel_back_normal.png" alt="previous"  class="thumb_p"/></span>');
            ...
            for (i = 0; i <= y-1; i++)
            {
                x.find(".thumb_box").append('<span><img src="'+d+'dactive-bnr.png" class="thumb_num" alt="'+i+'" /></span>');
            }
            ...
            x.find(".thumb_box").children("span").children("img").hover(
                    ...
                    switch($(this).attr("class")){
                        ...
                        case "thumb_num":
                            if(parseInt($(this).attr("alt")) != w){
                                $(this).attr("src",d+"active-bnr.png");
                            }
                            break;
                        case "thumb_n":
                ...
                function(){
                    switch($(this).attr("class")){
                        ...
                        case "thumb_num":
                            if(parseInt($(this).attr("alt")) != w){
                                $(this).attr("src",d+"dactive-bnr.png");
                            }
                            break;
                        case "thumb_n":
        ...
        function play(){
            ...
            x.find(".thumb_box").children("span").children("img[class='thumb_num']").attr("src",d+"dactive-bnr.png");
            x.find(".thumb_box").children("span").children("img[class='thumb_num']").eq(w).attr("src",d+"active-bnr.png");
